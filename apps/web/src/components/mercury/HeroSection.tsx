    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center">
                ...
                >
                    Strategic Vertical Analysis & GTM Strategy
                </p>

                <div data-animate data-delay="400" className="space-y-6">
                    <p className="text-xs sm:text-sm uppercase tracking-wider sm:tracking-widest" style={{ color: 'var(--mercury-text-muted)' }}>
                        Prepared by Daniel Yi
                    </p>

                    <div className="inline-flex items-center gap-2 text-xs sm:text-sm" style={{ color: 'var(--mercury-text-muted)' }}>
