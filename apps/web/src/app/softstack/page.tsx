...
import { PasswordGate } from "@/components/softstack/PasswordGate";
...
export default function SoftstackPage() {
  ...
  useEffect(() => {
    ...
    const auth = sessionStorage.getItem("softstack_auth");
    if (auth === "true") {
  ...
  const handlePasswordSubmit = (password: string) => {
    if (password === "softstack") {
      setIsAuthenticated(true);
      sessionStorage.setItem("softstack_auth", "true");
      return true;
    }
    return false;
  };
