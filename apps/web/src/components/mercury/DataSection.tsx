                ...
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    >
                        ...
                        <p className="text-sm" style={{ color: 'var(--mercury-text-muted)' }}>
                            The # of estimates within the Digital Marketing Agencies are low, so looking at an adjacent industry, SEO Service Agencies, shows us an even stronger growth trend.
                        </p>
                        <p className="text-sm" style={{ color: 'var(--mercury-text-muted)' }}>
                            This is further evidence that even if the market size estimates are off, we can be confident that the trends are correct.
                        </p>
                    </div>
                </div>
